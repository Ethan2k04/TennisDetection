...
TITLE_ORG = (SCREEN_WIDTH // 2 - 200, 80)
...
FPS_SCALE = 1
FPS_COLOR = (0, 255, 0)
FPS_ORG = (SCREEN_WIDTH - 160, 50)

# 提示文字的参数
HINT_THICKNESS = 3
HINT_SCALE = 1
HINT_COLOR = (0, 255, 0)
HINT_1_ORG = (30, SCREEN_HEIGHT - 260)
HINT_2_ORG = (30, SCREEN_HEIGHT - 200)
HINT_3_ORG = (30, SCREEN_HEIGHT - 140)
