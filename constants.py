...
# 屏幕分辨率相关的比例系数
TITLE_ORG_RATIO = (0.02, 0.05)
SCORE_ORG_RATIO = (0.02, 0.10)
FPS_ORG_RATIO = (0.02, 0.15)
HINT_1_ORG_RATIO = (0.02, 0.35)
HINT_2_ORG_RATIO = (0.02, 0.40)
HINT_3_ORG_RATIO = (0.02, 0.45)
LOG_VALID_ORG_RATIO = (0.13, 0.42)
LOG_INVALID_ORG_RATIO = (0.14, 0.42)
